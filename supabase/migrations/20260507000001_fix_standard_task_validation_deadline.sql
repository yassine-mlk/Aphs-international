-- Migration: Corriger validation_deadline manquant dans upsert_task_assignment pour tâches standard
-- Description: Régression introduite dans 20260504000000 - validation_deadline n'était pas sauvegardé pour les tâches standard
