-- =========================================
-- CONFIGURATION VIDÉOCONFÉRENCE SIMPLIFIÉE
...
-- Table des réunions vidéo (version simplifiée)
...
DROP FUNCTION IF EXISTS add_meeting_participant(UUID, UUID, TEXT, TEXT);
...
DROP FUNCTION IF EXISTS join_meeting(UUID, UUID);
...
DROP FUNCTION IF EXISTS end_meeting(UUID, UUID);
...
SELECT 'Configuration vidéoconférence simplifiée terminée avec succès !' as status; 