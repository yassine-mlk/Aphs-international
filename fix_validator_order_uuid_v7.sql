-- ============================================================
-- Correction v7 : Supprimer les contraintes FK avant de modifier les types
-- ============================================================

-- 1. Supprimer les contraintes de clé étrangère
ALTER TABLE task_visa_workflows DROP CONSTRAINT IF EXISTS task_visa_workflows_executor_id_fkey;
ALTER TABLE task_visa_workflows DROP CONSTRAINT IF EXISTS task_visa_workflows_validator_id_fkey;

-- 2. Supprimer les contraintes FK sur les autres tables visa
ALTER TABLE task_visa_validations DROP CONSTRAINT IF EXISTS task_visa_validations_validator_id_fkey;
ALTER TABLE task_visa_submissions DROP CONSTRAINT IF EXISTS task_visa_submissions_executor_id_fkey;
ALTER TABLE task_visa_history DROP CONSTRAINT IF EXISTS task_visa_history_actor_id_fkey;

-- 3. Modifier la table task_visa_workflows pour utiliser TEXT[]
...
-- 4. Modifier les autres tables pour utiliser TEXT
ALTER TABLE task_visa_validations ALTER COLUMN validator_id TYPE TEXT;
ALTER TABLE task_visa_submissions ALTER COLUMN executor_id TYPE TEXT;
ALTER TABLE task_visa_history ALTER COLUMN actor_id TYPE TEXT;

-- 5. Supprimer et recréer la fonction
